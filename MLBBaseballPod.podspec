#
#  Be sure to run `pod spec lint MLBBaseballPod.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "John Seubert"
  # s.authors            = { "John Seubert" => "jaseubert@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/jseubert/MLBBaseballPod", :tag => "#{s.version}" }
  ...
  # s.exclude_files = "MLBBaseballPod/Exclude"
